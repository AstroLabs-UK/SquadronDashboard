...
async function branchRef(cwd) {
  // 'release' is the repo's default branch; 'main'/'master' stay as fallbacks for older clones.
  for (const ref of ['origin/release', 'origin/main', 'origin/master', 'origin/HEAD']) {
