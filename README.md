...
- Sets up auto-shutdown (2h45m after every boot) and auto-update (checks this repo every 30 minutes and rebuilds automatically) as host-level systemd timers
